from app.schemas.user.types import type_defs as types_type_defs
from app.schemas.user.queries import type_defs as queries_type_defs
from app.schemas.user.mutations import type_defs as mutations_type_defs
